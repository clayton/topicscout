...
ActiveRecord::Schema[7.0].define(version: 2023_03_10_181758) do
  ...
  create_table "potentially_related_urls", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "url_id"
    t.uuid "topic_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["topic_id"], name: "index_potentially_related_urls_on_topic_id"
    t.index ["url_id"], name: "index_potentially_related_urls_on_url_id"
  end
