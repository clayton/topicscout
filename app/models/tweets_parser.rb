  ...
  def save_tweets(results)
    ...
    found_tweets.each do |tweet|
      ...
      urls.each do |url| 
        ...
        url.increment!(:impression_count, created_tweet.impression_count)
        url.increment!(:like_count, created_tweet.like_count)
        url.increment!(:retweet_count, created_tweet.retweet_count)
